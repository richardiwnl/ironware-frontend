...
import usuario from '../Register/usuarioRegister';
...
export default function Register() {
  ...
  useEffect(() => {
    document.title = 'Ironware | Cadastro de Administrador ';
  }, []);
  ...
  const handleFormSubmit = async e => {
    ...
    try {
      setIsLoading(true);
      await axios.post('auxiliares/', requestData);
      ...
      history.push('/administrativo/login');
    } catch (err) {
          ...
          <FlexboxGrid justify="center">
            <Panel header={<h3>Crie sua conta</h3>} bordered>
              ...
              <div style={helperStyle}>
                Já possui cadastro? Faça{' '}
                <a href="/administrativo/login">Login</a>
              </div>
            </Panel>
          </FlexboxGrid>
        </Content>
